...
/* Creates pkcs11 session -- returns session handle */
#define TEE_SESSION_CREATE 0x00000020
#define TEE_SESSION_CLOSE 0x00000021
#define TEE_APPLICATION_CLOSE 0x00000022
