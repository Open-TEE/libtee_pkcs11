...
#define TEE_SIGN_INIT		0x00000009
#define TEE_SIGN		0x0000000A
#define TEE_SIGN_UPDATE		0x0000000B
#define	TEE_SIGN_FINAL		0x0000000C

/* Functions for verifying signatures and MACs */
#define TEE_VERIFY_INIT		0x0000000D
#define TEE_VERIFY		0x0000000E
#define TEE_VERIFY_UPDATE	0x0000000F
#define	TEE_VERIFY_FINAL	0x00000010
